...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_NvidiaGPUStatus_To_core_NvidiaGPUStatus,
		Convert_core_NvidiaGPUStatus_To_v1_NvidiaGPUStatus,
...
func autoConvert_v1_NvidiaGPUStatus_To_core_NvidiaGPUStatus(in *v1.NvidiaGPUStatus, out *core.NvidiaGPUStatus, s conversion.Scope) error {
	out.Id = in.Id
	out.Healthy = in.Healthy
	return nil
}

// Convert_v1_NvidiaGPUStatus_To_core_NvidiaGPUStatus is an autogenerated conversion function.
func Convert_v1_NvidiaGPUStatus_To_core_NvidiaGPUStatus(in *v1.NvidiaGPUStatus, out *core.NvidiaGPUStatus, s conversion.Scope) error {
	return autoConvert_v1_NvidiaGPUStatus_To_core_NvidiaGPUStatus(in, out, s)
}

func autoConvert_core_NvidiaGPUStatus_To_v1_NvidiaGPUStatus(in *core.NvidiaGPUStatus, out *v1.NvidiaGPUStatus, s conversion.Scope) error {
	out.Id = in.Id
	out.Healthy = in.Healthy
	return nil
}

// Convert_core_NvidiaGPUStatus_To_v1_NvidiaGPUStatus is an autogenerated conversion function.
func Convert_core_NvidiaGPUStatus_To_v1_NvidiaGPUStatus(in *core.NvidiaGPUStatus, out *v1.NvidiaGPUStatus, s conversion.Scope) error {
	return autoConvert_core_NvidiaGPUStatus_To_v1_NvidiaGPUStatus(in, out, s)
}
