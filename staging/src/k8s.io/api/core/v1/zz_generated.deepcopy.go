...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NvidiaGPUStatus) DeepCopyInto(out *NvidiaGPUStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NvidiaGPUStatus.
func (in *NvidiaGPUStatus) DeepCopy() *NvidiaGPUStatus {
	if in == nil {
		return nil
	}
	out := new(NvidiaGPUStatus)
	in.DeepCopyInto(out)
	return out
}
